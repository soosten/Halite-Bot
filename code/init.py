...
INITIAL_PREMIUM = 0
CARGO_PREMIUM = 0
BASELINE_SHIP_RATE = 0.08  # controls whether we go straight home or visit further sites
BASELINE_YARD_RATE = 0.02  # controls general tendency to stray away from yard and mine longer
